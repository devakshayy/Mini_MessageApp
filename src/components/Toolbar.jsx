const Button = ({ children, onSmash }) => {
  ...
  return (
    <button onClick={onSmash} className="border rounded-md p-2 m-4">
      {children}
    </button>
  );
};
...
const PlayButton = ({ movieName }) => {
  ...
  return <Button onSmash={handlePlaybtn}>Play {movieName}</Button>;
};
    ...
    <div>
      <h1
        className="text-2xl 
                     ...
                     text-gray-500"
      >
        Here im implement the different onClick btn with same btn
      </h1>
